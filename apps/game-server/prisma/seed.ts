...
const INITIAL_ABILITIES = [
  ...
  { slug: 'throw-rock', name: 'Throw Rock', owner_type: 'both', category: 'attack', target_mode: 'single_enemy', damage_type: 'physical', power_source: 'monster_parameters', cooldown_ms: 5000, cooldown_group: 'attack', range_tiles: 6, allowed_parameters: [{ key: 'power', label: 'Power', min: 0, max: 10000 }], enabled: true },
